...
import {
  Grid, Typography, List, ListItem, Card, CardMedia, CardContent, Box, Rating
} from '@mui/material';
            ...
            <ListItem>
              <Card sx={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                  <CardContent sx={{ display: 'flex', flex: '1 0 auto', flexDirection: 'column', justifyContent: 'space-between' }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                      <Typography gutterBottom variant="h5" component="div" children={e.title} />
                      <Typography variant="body2" color="text.secondary" children={`Original title: ${e.original_title}`} />
                      <Typography variant="body2" color="text.secondary" children={e.overview} />
                    </Box>
                    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                      <Typography variant="body2" color="text.secondary" children={`Released: ${formatDate(e.release_date)}`} />
